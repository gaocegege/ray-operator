...
import (
	...
	"github.com/gaocegege/ray-operator/controllers"
...
func main() {
	...
	if err = (&controllers.RayReconciler{
		...
		Log:    ctrl.Log.WithName("controllers").WithName("Ray"),
		Composer: composer.New(mgr.GetEventRecorderFor(composer.ComposerName),
			mgr.GetScheme()),
